...
状态：**P0–P4 完成；P5 本机范围完成；P7 切换已执行（旧架构删除+布局恢复+真实项目验证）。剩余实机验收（macOS/签名/VM 矩阵/G5-G6/draft release）按用户指示由用户手动执行、排最后。** D1–D6 决策保持，见 [P0-06](records/P0-06.md) 与主计划 §2.3。更新日期：2026-09-25。
