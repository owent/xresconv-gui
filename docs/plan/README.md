...
状态：**P0–P4 完成；P5 本机范围完成（P5-04/07/08/10 阻塞于 macOS 主机/受控签名/VM 实机）。CI 推送验证完成（PR #60 运行级绿；win/macOS 桌面 E2E continue-on-error 已登记）。** D1–D6 决策保持，见 [P0-06](records/P0-06.md) 与主计划 §2.3。更新日期：2026-09-25。
...
D1–D5 已于 2026-09-23 由用户决策，登记于 [P0-06](records/P0-06.md)；新增 D6 以主计划 §2.3 和下表为准：
...
| D6：业务实现语言 | 用户要求：不用 Rust 重写业务，采用 Tauri 2 + 独立 Node.js；Rust 只保留 Tauri 必要构建/最小胶水 | P1-00 迁移审计、P1/P2/P3、测试和 CI 同步 |
